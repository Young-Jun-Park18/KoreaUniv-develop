  ...
  const newsData = [
    {
      ...
      title: '2025 미래도전 국방기술 연구개발사업 시연회',
      description: '• 기간 : 2025.9.22 \n• 장소 : 고려대학교 신공학관 315호 \n• 제로맵 측위 기술, 제로맵 디지털 트윈 기술 홍보 및 시연',
      link: 'https://rndpost.netlify.app/',
      date: '2025.09'
    },
    {
      id: 2,
      image: '/images/research2.png',
      title: '[머니투데이] 핍스디멘션, "도면만으로 3D 모델 생성" 디지털 트윈 新 패러다임',
    ...
    },
    {
      ...
      title: '[머니투데이] 대한민국 위치정보 우수 비즈니스모델 최우수상',
    ...
    },
    {
      ...
      title: '[머니투데이] 실내측위 원천기술로 딥테크 팁스 선정',
    ...
    },
    {
      ...
      title: '[벤처스퀘어] 핍스디멘션, 실내 공간의 한계를 허물다',
    ...
    },
    {
      ...
      title: '[머니투데이] 실내 측위·내비게이션으로 스타트업 분야 대상',
    ...
    },
    {
      ...
      title: '[머니투데이] 스마트폰으로 실내측위 혁신 핍스디멘션, 정밀도로 새 역사 쓴다',
    ...
    },
    {
      ...
      title: '[머니투데이] 세오, 핍스디멘션과 MOU 체결..공공조달 시장 공략 나서',
    ...
    },
    {
      ...
      title: '[아시아타임즈] LG 화학 여수 플랜트, 제로맵 실내측위 시스템 구축',
    ...
    },
    {
      ...
      title: '[엽합뉴스] 고려대 최린 교수, 2022 대한민국 산업기술진흥 유공자 선정',
    ...
    },
    {
      ...
      title: '[핀포인트뉴스] 딥러닝 기반 지자기 실내측위 NET 신기술인증',
      description: '딥러닝 기반 지자기 실내측위 기술이 산업통상자원부 산하 국가기술표준원의 NET 신기술인증을 획득',
      link: 'https://www.pinpointnews.co.kr/news/articleView.html?idxno=19477',
      date: '2020.12'
    },
    {
      id: 14,
      image: '/images/main1_2.jpg',
      title: '[전자신문] 세계 최초 수도권 지하철/KTX 역사 실내측위 시스템 및 실내 내비게이션 앱 개발 착수',
      description: '최린 교수 연구팀, 딥러닝 기반의 지자기 실내측위 기술을 이용 지하철 역사 내 교통약자 위한 맞춤형스마트 내비게이션 개발 계획',
      link: 'https://www.etnews.com/20221011000103#:~:text=%EC%B5%9C%EB%A6%B0%20%EA%B5%90%EC%88%98%20%EC%97%B0%EA%B5%AC%ED%8C%80%EC%9D%80%20%EC%97%AD%EC%82%AC%20%EB%82%B4%20%EC%8B%A4%EB%82%B4%EC%B8%A1%EC%9C%84%20%EC%8B%9C%EC%8A%A4%ED%85%9C,%EC%8B%A4%EB%82%B4%20%EB%82%B4%EB%B9%84%EA%B2%8C%EC%9D%B4%EC%85%98%20%EC%95%A0%ED%94%8C%EB%A6%AC%EC%BC%80%EC%9D%B4%EC%85%98(%EC%95%B1)%20%EA%B0%9C%EB%B0%9C%EC%9D%84%20%EB%8B%B4%EB%8B%B9%ED%95%9C%EB%8B%A4.%20Photo%20Image.', // 빈 링크
      date: '2022.11'
    },
    {
      id: 15,
      image: '/images/main555.jpeg',
      title: '[정보통신신문] 스마트폰만으로 실내 공간 위치 정밀 확인',
