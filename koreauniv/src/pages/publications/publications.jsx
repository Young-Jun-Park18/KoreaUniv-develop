  ...
  const conferencePublications = [
      ...
      items: [
        {
          ...
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: '[우수논문선정] 동적 디렉터리 테이블 : 공유 캐시 블록의 디렉터리 엔트리 동적 할당',
          desc: '배한준, 최 린<br>한국정보과학회 2017 한국컴퓨터종합학술대회 2017년 6월',
          lang: 'ko',
          tags: [{ text: 'Domestic', type: 'warning' }],
        },
        {
        ...
        {
          title: '보행자 추측 항법과 저전력 블루투스 지문인식을 이용한 실내 내비 게이션 시스템',
          desc: '김도윤, 구경현, 최 린<br>한국정보과학회 2017 한국컴퓨터종합학술대회 2017년 6월',
          lang: 'ko',
          tags: [{ text: 'Domestic', type: 'warning' }],
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          title: 'Cross-Layer Route Optimization using MAC overheariing for Reactive Routing Protocols in MANETs',
        ...
        {
          title: 'Influenza Surveillance and Forecast with Smartphone Sensors',
          desc: 'Sang Hoon Lee, Yunmook Nah and Lynn Choi<br>In the Proceedings of the 9th Workshop on Software Technologies for Future Embedded and Uqiquitous Systems(SEUS 2013), June 17-18, 2013, Paderborn, Germany',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
          ...
          desc: 'Sang Hoon Lee and Lynn Choi<br>In the Proceedings of the 2013 FTRA International Conference on Advanced IT, engineering and Manegement(FTRA AIM-13), February 21-23, 2013, Seoul, Korea',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
          title: 'Policy-based Automatic Energy Monitoring and Control for Green IDCs',
          desc: 'Sang Hoon Lee, Dong-wook Shin and Lynn Choi<br>In the Proceedings of the 2013 FTRA International Conference on Advanced IT, engineering and Manegement(FTRA AIM-13), February 21-23, 2013, Seoul, Korea',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
          title: 'Starcast: Robust and Energy-Efficient Geometric Routing for Mobile Sensor Networks',
          desc: 'Jae Kyun Jung, Sang Hoon Lee and Lynn Choi<br>In the Proceedings of the 2013 FTRA International Conference on Advanced IT, engineering and Manegement(FTRA AIM-13), February 21-23, 2013, Seoul, Korea',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: 'Policy-Based Reprogramming for Wrieless Sensor Networks',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'Lynn Choi, Jin Young Park<br>In the Proceedings of the 2009 International Conference on High Performance Computing & Simulation (HPCS 2009), pp. 82-88, June 2009, German',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
      ...
      items: [
        {
          ...
          desc: 'Lynn Choi, Jae Kyun Jung, Byong-Ha Cho, Hyohyun Choi<br>In the Proceedings of the 6th IFIP Workshop on Softerware Technologies for Future Embedded & Ubiquitous Systems (SEUS 2008), pp. 304 - 316 , Oct. 2008, Italy',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
          title: 'Accelerating Symmetric and Asymmetric Ciphers with Register File Extension for Multi-word and Long-word Operation',
          desc: '[ Invited paper ] Sang Hoon Lee, Lynn Choi<br>In the Proceedings of the International Conference on Information Science and Information Security (ICISS 2008), pp. 102-107, Jan. 2008, Korea',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
      ...
      items: [
        {
          ...
          desc: '[ Invited paper ] Sang Hoon Lee, Byong-Ha Cho, Lynn Choi, Sun-Joong Kim<br>In the Proceedings of the 5th IFIP Workshop on Software Technologies for Embedded & Ubiquitous Systems (SEUS 2007), pp. 419-428, May 2007, Greece',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
          title: 'AMAC_Traffic-Adaptive Sensor Network Mac Protocol through Variable Duty-Cycle Operations',
          desc: 'SangHoon Lee, Joon Ho Park, and Lynn Choi (2007)<br>In the Proceedings of the IEEE International Conference on Communications 2007,(ICC 2007), pp. 3259-3264, June 2007, Scotland',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
      ...
      items: [
        {
          ...
          desc: 'Lynn Choi, Jaesung Heo, Hygon Kim, Sunil Kim (2004)<br>In the Proceedings of NETWORKING 2004: Networking Technologies, Services, and Protocols; Performance of Computer and Communication Networks; Mobile and Wireless Communications, vol. 3042, pages 296-307, Athens, Greece, May 2004',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
          title: 'Enforcement_of_Architectural_Safety_Guards_to_Deter_Malicious_Code_Attacks through Buffer Overflow Vulnerabilities',
          desc: 'Lynn Choi, Yong Shin (2004)<br>In the Proceedings of ARCS 2004, International Conference on. Architecture of Computing Systems. - Organic and Pervasive Computing vol. 2981, pages 47-60, Augsburg, Germany, March 2004',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
          title: 'Taming_Large_Classifiers_with_Rule_Reference_Locality',
          desc: 'Hyogon Kim, Jaesung Heo, Lynn Choi, Inhye Kang, Sunil Kim (2004)<br>In the Proceedings of Information Networking: Networking Technologies for Enhanced Internet Services, Vol. 2662, pages 928-937, Feb. 2003',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'D. K. Kim, S. J. Lee, L. Choi, C. H. Kang<br>In the Proceedings of 5th IFIP/IEEE International Conference on Management of Multimedia Networks and Services, MMNS, Santa Babara, CA,Oct.2002',
          lang: 'en',
          tags: [{ text: 'International', type: 'warning' }],
        },
        {
          title: '계층 구조의 Deck을 갖는 HTML Filter 구현 방안',
